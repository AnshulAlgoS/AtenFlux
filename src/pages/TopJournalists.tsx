...
// Color palette for journalists - cycling through for variety
const COLORS = ["#10B981", "#EC4899", "#F97316", "#EAB308", "#3B82F6", "#8B5CF6", "#F59E0B", "#EF4444", "#14B8A6", "#A855F7"];
    ...
    for (const url of urls) {
      try {
        ...
        if (list && list.length > 0) {
          data = list.map((j, i) => ({
            ...j,
            topics: j.topics?.slice(0, 5) || [], // Show first 5 topics (all from DB, no filtering)
